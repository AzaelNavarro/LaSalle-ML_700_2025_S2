...
URL_POST = "https://ef532a86-c48e-4cf5-8792-441a5faeafbd-00-15rwru2eu6u7x.spock.replit.dev/insert/ANJ_ROBOT_TELEMETRIA"
...
def capture_photo_to_base64():
    ...
    try:
        ...
        if not ret:
            print("Cámara: error al codificar la imagen")
            return None
...
def send_telemetry(base64_image_date):
    selected_id = 911
    ...
    payload = {
        ...
        "CARGA_BATERIA": 90,
        "IMAGEN_BASE64": base64_image_date
    }
    ...
    try:
        ...
        if response.status_code == 200 or response.status_code == 201:
            ...
            print("POST: Error en la respuesta del servidor.")
